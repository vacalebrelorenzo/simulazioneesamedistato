...
function caricaFormProfilo(infoUtente) {
    ...
    let btnBloccoCarta = '<button type="button" class="btn btn-danger btn-lg btn-block mt-3" onclick="bloccaSmartCard()">Blocca Smart Card</button>';
    ...
    $("#form-container").html(username + email + password+ nome + cognome + numeroCarta + btnUpdate + btnBloccoCarta + btnIndietro);
}
